...
most common forms of an __optimization problem__.

Consider the following problem:

> __problem__. Suppose we have a wire of length ${1.}$ The wire is cut into
...
> __postulate__. The maximum or minimum value does not always occur when
...
> __problem__. Let ${b}$ be a box without a top. Find the least surface
...
> __problem__. Given a rectangle ${R}$'s perimeter ${P,}$ what are the
...
__constraint__ &mdash; the volume is fixed. This means that the quantiy

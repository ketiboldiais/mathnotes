...
> __problem__. Without a calculator, compute ${\sqrt{5}.}$
...
> __newton's wethod__. Let ${f(x)}$ be a function. If ${f(x)}$ is
...
${E_n = \lvert x - x_n \rvert }$ is the __error margin__. The distance

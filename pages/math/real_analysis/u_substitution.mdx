...
method is the __method of substitution__. To illustrate this method,
consider the following problem:

> __problem__. Evaluate the indefinite integral:
>
> $$
> 	\int x^3(x^4 + 2)^5 dx
> $$
...
subsitution we can use &mdash; __premonitory substitution__. The idea is

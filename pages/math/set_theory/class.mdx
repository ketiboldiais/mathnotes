<head>
	<title>Classes</title>
	<description>Notes on classes in set theory.</description>
</head>
...
$$
	\set{\sf{x}:\sf{x}\tt{ has property }\sf{P}}
$$
...
$$
	X = \set{X : \tt{${X}$ is a set and ${X}$ has at least one element}}
$$
...
$$
	\Rr = \set{\Rr : \tt{${\Rr}$ is a set and ${\Rr}$ is not an element of
	itself}}.
$$

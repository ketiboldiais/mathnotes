...
> _Product Rule of Exponents_. For any ${a \in \RR,}$ given ${m \in \NN}$ and
> ${n \in \NN:}$ ${a^m a^n = a^{m + n}}$
...
> _The Quotient Rule of Exponents_. For any ${a \in \RR,}$ and
> ${m \in \NN,}$ > ${n \in \NN,}$ such that ${m > n,}$ >
> ${\dfrac{a^m}{a^n} = a^{m - n}}$

and this rule:

> _The Negative Rule of Exponents_. For any ${a \in \RR,}$ and
> ${n \in \NN,}$ > ${a^{-n} = \dfrac{1}{a^n}}$
...
> _The Zero Exponent Rule_. For any ${\{a \in \RR : a \neq 0 \},}$ >
> ${a^0 = 1.}$
...
> _The Power Rule of Exponents_. For any ${a \in \RR,}$ and ${m \in \NN,}$ >
> ${n \in \NN,}$ ${(a^m)^n = a^{m \cdot n}}$
...
> _The Power of a Product Rule of Exponents._ For all ${a, b \in \RR,}$
> given a ${n \in \NN,}$ ${(ab)^n = a^n b^n}$
...
> _The Power of a Quotient Rule of Exponents._ For all ${a, b \in \RR}$ and
> any ${n \in \ZZ,}$ $$\left( \dfrac{a}{b} \right)^n = \dfrac{a^n}{b^n}$$

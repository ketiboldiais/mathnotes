...
special symbol, ${\ZZ,}$ from the German zehr, meaning "number".

${ \ZZ = \{ \ldots , \texttt{-}4, \texttt{-}3, \texttt{-}2, \texttt{-}1, 0,
1, 2, 3, 4, \ldots \} }$
...
$$
\ZZ^{-} = \{ \ldots , \texttt{-}4, \texttt{-}3, \texttt{-}2, \texttt{-}1
\}
$$

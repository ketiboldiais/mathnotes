...
> Definition. Let ${x \in \ZZ.}$ >
> ${x \in \Z_{\text{even}} \iff x = 2k : k \in \ZZ^{+}}$ I.e., an integer
...
> Definition. Let ${x \in \ZZ.}$ >
> ${x \in \Z_{\text{odd}} \iff x = 2k - 1 : k \in \ZZ^{+}}$
...
> Definition. Let ${x \in \ZZ.}$ >
> ${x \in \Z_{\text{odd}} \iff x = 2k + 1 : k \in \NN}$
...
> __lemma__. Let ${a, b \in \ZZ^{+}.}$ Then:
>
> 1. ${a, b \in \Z_{\text{even}} \implies a + b \in \Z_{\text{even}}}$
> 2. ${[(a \in \Z_{\text{even}}) \land (b \in \Z_{\text{odd}})] \implies a - b \in \ZZ\_{\text{odd}}}$
> 3. ${[(a \in \Z_{\text{odd}}) \land (b \in \Z_{\text{even}})] \implies a - b \in \ZZ\_{\text{odd}}}$
...
Let's prove the first property. First, the hypothesis to be proved:
    ...
    Let ${a, b \in \ZZ^{+}.}$ If ${a \in \Z_{\text{even}}}$ and ${b \in \Z_{\text{even},}}$ then ${a + b \in \Z_{\text{even}}.}$
...
where ${n, m \in \ZZ^{+}}$. Thus, by substitution, the expression ${a + b}$
can be written as:
...
> Let ${a,b \in \ZZ^{+}.}$ If ${a}$ is even and ${b}$ is odd, then ${a + b}$
> is odd.
...
> Definition. Let ${a \in \ZZ^{+}}$ and ${b \in \ZZ.}$ Then:
>
> $$

...
If ${b \in \RR^{-},}$ then we arrive at some difficulty. Remember,
...
Because the natural domain of the functions we are dealing with is ${\RR,}$
the logarithmic function is _undefined_ where ${b \in \RR^{-}.}$ Now

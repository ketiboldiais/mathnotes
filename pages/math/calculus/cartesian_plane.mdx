...
<Plot geo={[
	{type:'label', xy: [4,5], id: '\\RR^+ \\times \\RR^+', fontSize:0.9,w:60},
	{type:'label', xy: [-7,5], id: '\\RR^- \\times \\RR^+', fontSize:0.9,w:60},
	{type:'label', xy: [-7,-4], id: '\\RR^- \\times \\RR^-', fontSize:0.9,w:60},
	{type:'label', xy: [4,-4], id: '\\RR^+ \\times \\RR^-', fontSize:0.9,w:60},
]}/>

...
<Metadata title={'Trigonometry'} description={'Notes on trigonometry'}
...
$$
	\sin \theta = \dfrac{\tt{opposite}}{\tt{hypotenuse}} = \dfrac{a}{h}
$$
...
$$
	\cos \theta = \dfrac{\tt{adjacent}}{\tt{hypotenuse}} = \dfrac{b}{h}
$$
...
$$
	\tan \theta = \dfrac{\tt{opposite}}{\tt{adjacent}} = \dfrac{a}{b}
$$
...
$$
	\cot \theta = \dfrac{\tt{adjacent}}{\tt{opposite}} = \dfrac{b}{a}
$$
...
$$
	\sec \theta = \dfrac{\tt{hypotenuse}}{\tt{adjacent}} = \dfrac{h}{b}
$$
...
$$
	\csc \theta = \dfrac{\tt{hypotenuse}}{\tt{opposite}} = \dfrac{h}{a}
$$
...
$$
	\eqs{
		\Oo &= \tt{the side opposite to $\theta$} \\
		A &= \tt{the side adjacent to $\theta$} \\
		H &= \tt{the hypotenuse} \\
	}
$$
...
$$
	\cos \theta = \dfrac{\tt{adjacent}}{\tt{hypotenuse}} ~~~~
	\sin \theta = \dfrac{\tt{opposite}}{\tt{hypotenuse}}
$$

And since the radius of the circle is ${1,}$ that hypotenuse is 1:

$$
	\cos \theta = \dfrac{\tt{adjacent}}{1} ~~~~
	\sin \theta = \dfrac{\tt{opposite}}{1}
$$
...
$$
	x^2 + y^2 = 1 \implies (\cos \theta)^2 + (\sin \theta)^2 = 1
$$
...
$$
	\sin \theta = \cos \paren{\dfrac{\pi}{2} - \theta}
$$

$$
	\sec \theta = \csc \paren{\dfrac{\pi}{2} - \theta}
$$

$$
	\tan \theta = \cot \paren{\dfrac{\pi}{2} - \theta}
$$

$$
	\cos \theta = \sin \paren{\dfrac{\pi}{2} - \theta}
$$

$$
	\csc \theta = \sec \paren{\dfrac{\pi}{2} - \theta}
$$

$$
	\cot \theta = \tan \paren{\dfrac{\pi}{2} - \theta}
$$
...
$$
	\cos\paren{\frac{\pi}{2} - \alpha + \beta} =
	\cos \paren{\frac{\pi}{2} - \alpha} \cos \beta - \sin \paren{\frac{\pi}{2} - \alpha} \sin \beta
$$
...
$$
	\small
	\tnote{\cos\paren{\frac{\pi}{2} - \alpha + \beta}}{$\sin(\alpha - \beta)$} 
	=
	\tnote{\cos \paren{\frac{\pi}{2} - \alpha}}{$\sin \alpha$}
	\cos \beta
	- \tnote{\sin \paren{\frac{\pi}{2} - \alpha}}{$\cos \alpha$}
	\sin \beta
$$
...
$$
	\cos(\theta) = 2 \cos^2\paren{\dfrac{\theta}{2}} - 1
$$
...
$$
	\eqs{
		1 + \cos(\theta) &= 2 \cos^2\paren{\dfrac{\theta}{2}} - 1 + 1 \\[1em]
...
$$
	1 + \cos(\theta) = 2 \cos^2 \paren{ \dfrac{\theta}{2} }
$$

Let's flip the equation:

$$
	2 \cos^2 \paren{ \dfrac{\theta}{2} } = 1 + \cos \theta
$$

Now let's divide by ${2:}$

$$
	\cos^2 \paren{ \dfrac{\theta}{2} } = \dfrac{1 + \cos \theta}{2}
$$
...
$$
\eqs{
	\sqrt{\cos^2\paren{\dfrac{\theta}{2}}} &= \pm \sqrt{\dfrac{1 + \cos
	\theta}{2}} \\[1em]
	\cos \paren{\dfrac{\theta}{2}} &= \pm \sqrt{\dfrac{1 + \cos \theta}{2}}
}
$$
...
$$
	\sin \paren{\dfrac{\theta}{2}} = \pm \sqrt{\dfrac{1 - \cos \theta}{2}}
$$

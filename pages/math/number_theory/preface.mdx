...
To solve these questions, mathematicians created a new set of numbers, ${\ZZ.}$
...
Once again, the mathematicians created another set of numbers: ${\QQ.}$
...
Once more, another set emerged — ${\RR.}$ Then the mathematicians encountered
...
numbers, ${\CC.}$ These new sets have generated their own fields — the reals are

...
The part of the proposition ${\forall n \in \NN}$ is called the **domain of
discourse**. This tells us that the predicate ${prime(n^2 + n + 41)}$
relates only to ${n \in \NN.}$ We're not talking about the real numbers,
...
To show that ${\forall \in \NN: prime(n^2 + n + 41)}$ is true, we have to
...
The proposition ${\forall n \in \NN: prime(n^2 + n + 41)}$ is false. Here is
...
$$
	\exists a, b, c, d \in \ZZ^{+} : a^4 + b^4 + c^4 = d^4
$$
...
In formal notation: ${\nexists x, y, z \in \ZZ^{+} : 313(x^3 + y^3 = z^3).}$
...
$$
	\forall n \in \ZZ: (n \geq 2 \implies n^2 \geq 4)
$$
...
$$
	\forall n \in \ZZ: (n \geq 2 \iff n^2 \geq 4)
$$

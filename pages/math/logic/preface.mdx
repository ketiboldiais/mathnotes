...
\eqs{
&\text{Every } \tnote{\text{mammal}}{$B$} \text{ is an } \tnote{\text{animal,}}{$A$} 
\\
\\
\\
&\text{and every } \tnote{\text{dog}}{$C$} \text{ is a } \tnote{\text{mammal,}}{$B$}
\\
\\
\\
&\text{so every } \tnote{\text{dog}}{$C$} \text{ is an } \tnote{\text{animal.}}{$A$}
}

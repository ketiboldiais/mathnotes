...
<Metadata
	title={"Static Arrays"}
	description={"Notes on statics arrays and sequences."}
	keywords={"Static arrays, sequences, vectors"}
/>
...
1. [Sequence Constructor](#sequence-constructor)
2. [Sequence Destructor](#sequence-destructor)
3. [Fullness Tester](#fullness-tester)
4. [Empty Tester](#empty-tester)
5. [Size Getter](#size-getter)
6. [Length Getter](#length-getter)
7. [Sequential Print](#sequential-print)
8. [Appending an Element](#appending-an-element)
9. [Inserting an Element](#inserting-an-element)
10. [Removing an Element](#removing-an-element)
11. [Accessing an Array Element](#accessing-an-array-element)
12. [Setting](#setting)
13. [Sequence ADT: Auxiliary Functions](#sequence-adt-auxiliary-functions)
14. [Shifting & Rotating](#shifting--rotating)
      1. [Negatives Towards Start & Positives Towards End](#negatives-towards-start--positives-towards-end)
15. [Binary Operations on Arrays](#binary-operations-on-arrays)
16. [Appending an Array Element](#appending-an-array-element)
17. [Merging Arrays](#merging-arrays)
18. [Set Operations on Arrays](#set-operations-on-arrays)
19. [Union of Arrays](#union-of-arrays)
20. [Intersection](#intersection)
21. [Difference](#difference)
22. [Search-and-rescue Algorithms: Algorithms for Finding Missing Elements](#search-and-rescue-algorithms-algorithms-for-finding-missing-elements)
...
23. [Duplicate Handling](#duplicate-handling)
...
24. [Useful Applications](#useful-applications)
25. [Finding the Total Number of Duplicates](#finding-the-total-number-of-duplicates)
26. [Duplicate Counter: Counting Duplicates in an Unsorted Sequence](#duplicate-counter-counting-duplicates-in-an-unsorted-sequence)
27. [Pair to Sum: Unsorted Arrays](#pair-to-sum-unsorted-arrays)
28. [Pair to Sum: Sorted Arrays](#pair-to-sum-sorted-arrays)
29. [Finding a Minimum and a Maximum in a Single Scan](#finding-a-minimum-and-a-maximum-in-a-single-scan)
30. [Array Addressing](#array-addressing)
31. [Linear Search](#linear-search)
32. [Transposition](#transposition)
33. [Move-to-head](#move-to-head)
34. [Maximum Finder](#maximum-finder)
35. [Minimum Finder](#minimum-finder)
36. [Reversing Array Elements](#reversing-array-elements)
37. [Reversing with an Auxiliary Array](#reversing-with-an-auxiliary-array)
38. [Reversing in Place](#reversing-in-place)
39. [Rotating an Array](#rotating-an-array)
40. [Shifting Array Elements](#shifting-array-elements)
41. [Checking if an Array is Sorted](#checking-if-an-array-is-sorted)
42. [Sorted Insertion](#sorted-insertion)
43. [Summing Elements](#summing-elements)
44. [Arithmetic Mean](#arithmetic-mean)
45. [Cost-benefit Analysis: Arrays](#cost-benefit-analysis-arrays)

</div>

The first set of abstract data types we explore is the **static array**. In
the materials that follow, we will use the terms _static array_ and
_sequence_ interchangeably.
...
<Sequence data={[5, 8, 3, 9]} scale={30} />
...
Arrays have costs and benefits. Because array's have a fixed size,
accessing the array's elements takes constant time—${O(1).}$ This is, in
fact, the greatest selling point for static arrays. Other basic data
structures like linked lists, stacks, or queues cannot do this.
...
<Sequence data={[1, 3, 4, 2, 8, "", ""]} scale={30} />
...
<Sequence data={[7, 3, 9, 1, "", ""]} scale={30} />

When we call `append(seq, 5)`, the sequence changes to:

<Sequence data={[7, 3, 9, 1, 5, ""]} scale={30} />
...
$$
 \sum\limits_{k = 1}^{n} k = \dfrac{n(n+1)}{2} \qquad \text{where} ~~~~ k, n \in \NN
$$
...
- **Ease of use**. Arrays have the benefit of being simple to use. Almost
  all languages provide a simple, native way of instantiating them,
  alongside a variety of methods for manipulating them.

- **Constant-time access.** Because arrays are a contiguous data structure,
  we can read array data in constant time.

- **Efficient memory usage.** Because arrays are a contiguous sequence of
...
- **Static structure.** Static arrays are immutable. Thus, once they're
  declared in memory, they cannot be modified.

- **Restricted Insertion and Deletion.** Because static arrays inherently
...
<TableMatrix headers={["add", "remove"]}>

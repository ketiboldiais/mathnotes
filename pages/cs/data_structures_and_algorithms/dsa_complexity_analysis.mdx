...
1. [Foundational Mathematics](#foundational-mathematics)
2. [Knuth's Model](#knuths-model)
3. [Complexity Functions](#complexity-functions)
...
5. [Relationships Between Asymptotic Notations](#relationships-between-asymptotic-notations)
...
8. [Limitations of Asymptotic Notations](#limitations-of-asymptotic-notations)
...
The materials in this volume assume elementary mathematical constructs. These constructs may be found via [this reference](./../../math/reference).

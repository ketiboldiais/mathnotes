...
<head>
	...
	<description>Notes on string algorithms.</description>
</head>
...
2. Suppose ${i \in \ZZ^{+}}$ and ${j = \ZZ^{+},}$ where both ${i}$ and ${j}$
   are initially ${0.}$
...
2. Let ${\lang i \in \NN \mid i < \ell \rang.}$
3. Let ${\lang j \in \NN \mid 0 < j \leq \ell \rang.}$

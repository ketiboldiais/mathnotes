...
<Metadata
	...
	description={"Notes on dynamic arrays"}
	keywords={"Dynamic arrays, vectors, data structures and algorithms"}
/>
...
**vector**. Below, we examine some implementations of the vector type. For

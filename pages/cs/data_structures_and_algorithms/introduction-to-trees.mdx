...
<head>
	...
	<description>General notes on trees.</description>
</head>
...
A **ternary tree** is a 3-ary tree, so ${k=3.}$ Thus, in a ternary tree,
...
either ${0}$ or ${3}$ children. A **strict 4-ary tree** is a 4-ary tree
...
> _Lemma: Strict ${k}$-ary Shrub Sizes_. Let ${H \in \ZZ+}$ and
> ${k \in \ZZ+.}$ The minimum number of nodes, i.e., the _minimum size_,
...
> _Lemma: Strict ${k}$-ary Shrub Sizes_. Let ${H \in \ZZ+}$ and
> ${k \in \ZZ+.}$ The maximum number of nodes, i.e., the _maximum size_,
> necessary to achieving a k-ary tree of height ${H}$ is the _strict
...
> _Lemma: Strict ${k}$-ary Shrub Height_. Let ${N, k \in \ZZ^+.}$ Given
...
> _Lemma: Strict ${k}$-ary Timber Height_. Let ${N, k \in \ZZ^+.}$ Given
...
> __lemma__. Let ${k, \ell, b \in \ZZ^+,}$ where ${\ell}$ is the number of

...
1. __let__ ${\dk obj = \lbrace}$
	1. ${a:\dk 1,}$
	2. ${b:\dk 2,}$
	3. ${c:\dk \string{foobar}}$
2. ${\rbrace;}$

</Algo>

Each of ${a,}$ ${b,}$ and ${c}$ above are called _keys_, and their assigned values _values_. In short, the JavaScript object

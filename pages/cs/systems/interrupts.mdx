...
This article covers notes on __interrupts__ — events that break the normal
...
level of the computer system. At the lowest level are __exceptions__. These
...
At the higher levels, we have __context switches__. Operating system
exceptions that allow us to go from apps like Word to Chrome to some notes
app very quickly. __Signals__ are exception mechanisms that we, as

...
export const renderRay = (selection, datum, index, xScale, yScale, plotLineColor) => {
	...
	insertArrowDefinitions(canvas,"ray_arrow_end",0,0,8,8,"auto",endPointFill);
	defineCircleMarkers(canvas,"ray_start_point",5,endPointFill,endPointFill);
	const line = canvas.append("line");
	const arrowEnd = "url(#ray_arrow_end)";
	const circleStart = "url(#ray_start_point)";
	const lineProperties = {
		x1, y1, x2, y2,
		class: className, stroke,

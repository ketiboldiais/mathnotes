...
const Routes = [
	...
	{ name: "Review of Mathematics", path: `${math}/preface`,children: [
		...
		{ name: "Combinatorics", path: `${math}${com}preface`, children: [
		...
		{ name: "Abstract Algebra", path: `${math}${aba}preface`, children: [
			{ name: "Basic Notions", path: `${math}${aba}intro-to-abstract-algebra`, children: [
		...
		{ name: "Linear Algebra", path: `${math}${lin}gaussian-elimination`, children: [
		...
		{ name: "Probability Theory", path: `${math}${proba}intro`, children: [
	...
	{ name: "Review of Computer Science",
		...
		children: [
			...
			{ name: "Data Structures & Algorithms", path: `${cs}${dsa}intro`, children: [
					...
					{ name: "Graphs", path: `${cs}${dsa}graph-algorithms`, children: [
			...
			{ name: "Computer Systems", path: `${cs}${sys}intro`, children: [
					...
					{ name: "Computer Networks", path: `${cs}${sys}networks`, children: [
						{ name: "Overview", path: `${cs}${sys}computer-networks` },
						{ name: "Application Layer", path: `${cs}${sys}osi-application-layer`, children:[
							{ name: "Application Architectures", path: `${cs}${sys}osi-application-layer#application-architectures` },
							{ name: "Client-server Applications", path: `${cs}${sys}osi-application-layer#client-server-applications` },
							{ name: "P2P Applications", path: `${cs}${sys}osi-application-layer#p2p-applications` },
							{ name: "Hybrid Applications", path: `${cs}${sys}osi-application-layer#hybrid-applications` },
							{ name: "Network Processes", path: `${cs}${sys}osi-application-layer#processes` },
							{ name: "What Is a Socket?", path: `${cs}${sys}osi-application-layer#sockets` },
							{ name: "Web Browsing", path: `${cs}${sys}osi-application-layer#web-browsing`, children: [
								{ name: "HTTP Connections", path: `${cs}${sys}osi-application-layer#http-connections` },
								{ name: "Nonpersistent HTTP", path: `${cs}${sys}osi-application-layer#nonpersistent-http` },
								{ name: "Persistent HTTP", path: `${cs}${sys}osi-application-layer#persistent-http` },
								{ name: "Persistent HTTP without Pipelining", path: `${cs}${sys}osi-application-layer#persistent-http-without-pipelining` },
								{ name: "Persistent HTTP with Pipelining", path: `${cs}${sys}osi-application-layer#persistent-http-with-pipelining` },
								{ name: "How a Browser Works in General", path: `${cs}${sys}osi-application-layer#browser-workflow`, children: [
									{ name: "The HTTP Request Message", path: `${cs}${sys}osi-application-layer#http-request-message` },
									{ name: "HTTP Methods", path: `${cs}${sys}osi-application-layer#http-methods` },
									{ name: "The HTTP Response Message", path: `${cs}${sys}osi-application-layer#reading-the-http-response-message` },
								]},
							]},
							{ name: "Cookies", path: `${cs}${sys}osi-application-layer#cookies` },
							{ name: "Web Caches", path: `${cs}${sys}osi-application-layer#web-caches` },
